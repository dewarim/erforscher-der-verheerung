...
|Sinnesupgrade: Ohren| Verbesserter Hörsinn (sowohl Ortsbestimmung als auch )|+3 Wahrnehmung
...
|Künstliches Auge (einfach)| Sehen im Infrarot-Bereich, Zielerfassung (in Verbindung mit Brain-CPU) | 300K | +3 Wahrnehmung
