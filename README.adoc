...
Proben auf Attribute: Attribut + 3W6 +- Modifikator(Schwierigkeit), Ergebnis muß bei >20 liegen.
...
Für Abenteuer bekommt man Erfahrung. Mit Erfahrung bekommt man Level. Mit Leveln bekommt man Attribut-Punkte zum Verteilen (+1 in Lv 1,2,3,5,6 und danach +1 alle 3 Level).

Mit zusätzlichen Leveln bekommt man auch zusätzliche Skills - wähle +1 Skill in jedem geraden Level (2,4,6,...).

Und je länger dein Charakter dabei ist, desto besser kann er in seinen Skills werden. Pro Level verteile 3 Skillpunkte (= Bonus auf deinen Würfelwurf, wenn du Skillproben machst)
